...
export default function Map({ showDemoRoute }) {
	...
	// https://www.pngmart.com/files/23/Editing-Red-Glow-PNG-Pic.png
	return (
		<div style={{ height: 'calc(100vh - 5rem - 56px)', width: '100%' }}>
			<MapContainer center={[50.376, -4.137]} zoom={13} ref={mapRef} style={{ height: '100%', width: '100%' }}>
				...
				{showDemoRoute && (
					<>
						<Marker position={[50.392, -4.12]} icon={customIcon}>
